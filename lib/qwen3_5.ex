defmodule Qwen3_5 do
  @moduledoc """
  Qwen3.5 decoder, with attention supplied by FlashAttention-3.
  ...
  See `Qwen3_5.Config` for the shapes and `Qwen3_5.Training` for the finetuning
  step. Only LoRA parameters are trained; see `Qwen3_5.LoRA` for why.
  """
